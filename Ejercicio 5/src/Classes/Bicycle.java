 ...
 * la creación de objetos de tipo bicicleta con toda la información 
...
public class Bicycle extends Vehicle {
    ...
    /**
     * Constructor de la clase bicicleta, el cual sirve
     * para la creación de cada uno de los elementos de tipo bicicleta
     * con toda su información.
     * @param type Hace referencia al tipo de vehículo, en este caso bicicleta.
